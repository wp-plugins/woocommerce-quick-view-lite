...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
	...
	?>
	<div class="post-<?php echo $pid; ?> product type-product status-publish has-post-thumbnail shipping-taxable purchasable product-type-external instock" id="product-<?php echo $pid; ?>" itemtype="http://schema.org/Product" itemscope="">
	...
	?>	
		...
		<p class="cart">
			...
			<a class="single_add_to_cart_button button alt" href='<?php echo apply_filters( 'woocommerce_product_add_to_cart_url', $_product->get_product_url(), $_product ); ?>' ><?php echo apply_filters( 'woocommerce_product_single_add_to_cart_text', $_product->get_button_text(), $_product ); ?></a>
